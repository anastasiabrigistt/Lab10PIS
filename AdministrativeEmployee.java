public class AdministrativeEmployee extends Employee {
    ...
    static class Main {
        public static void main(String[] args) {
            Employee admin = new AdministrativeEmployee(1245, "Anastasia Brigadina", "brigadinaai@gmail.com");
            Faculty faculty = new Faculty(new AdministrativeEmployee(1902, "Krylovetskaya Tatiana", "zamdekanFkn@yandex.ru"), "Faculty of Computer Science");
            ResearchAssociate scientist = new ResearchAssociate(100902, "Shabunin Artyom", "dimitriFIZ@yandex.ru", "Radio electronics");
            ...
            admin.setEmail("faraon962@yandex.ru");
            admin.setSsNo(9432);
